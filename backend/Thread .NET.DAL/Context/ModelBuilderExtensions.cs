...
namespace Thread_.NET.DAL.Context
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void Configure(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DisPostReaction>()
               .HasOne(pr => pr.Post)
               .WithMany()
               .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<DisCommentReaction>()
                .HasOne(pr => pr.Comment)
                .WithMany()
                .OnDelete(DeleteBehavior.Restrict);
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            var postReactions = GenerateRandomReactions(posts, users);
            var postDisReactions = GenerateRandomDisReactions(posts, users);
            ...
            modelBuilder.Entity<DisPostReaction>().HasData(postDisReactions);
        ...
        public static ICollection<PostReaction> GenerateRandomReactions(ICollection<Post> posts, ICollection<User> users)
        {
            int reactionId = 1;

            var reactionsFake = new Faker<PostReaction>()
        ...
        public static ICollection<DisPostReaction> GenerateRandomDisReactions(ICollection<Post> posts, ICollection<User> users)
        {
            int postReactionId = 1;

            var postReactionsFake = new Faker<DisPostReaction>()
